...
<head>
  ...
  <title>E-REPORT SARPRAS</title>
  <link rel="icon" href="../assets/dist/img/sarpras.png">
...
<div class="wrapper">
  ...
  <!-- /.navbar -->
    ...
    <a href="index.php" class="brand-link">
      <img src="../assets/dist/img/sarpras.png" alt="E-REPORT SARPRAS" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light" style="font-size: 19px;">E-REPORT SARPRAS</span>
    </a>
